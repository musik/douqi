  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved plant as @plant" do
        ...
        post :create, {:plant => { "name" => "invalid value" }}, valid_session
        assigns(:plant).should be_a_new(Plant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested plant" do
        ...
        Plant.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => plant.to_param, :plant => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the plant as @plant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Plant.any_instance.stub(:save).and_return(false)
        put :update, {:id => plant.to_param, :plant => { "name" => "invalid value" }}, valid_session
        assigns(:plant).should eq(plant)
      end
